                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Chat with WagGPT</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Learn about David. Ask anything or try an example.</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. does David require sponsorship to work in the U.S.?)"
                            disabled={isLoading}
