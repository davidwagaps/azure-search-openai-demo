...
#       + "Each source has a name followed by colon and the actual information, always include the source name for each fact you use in the response. "
    ...
    question = """
'How long has David been in Product Management?'

Sources:
info1.txt: Product manager at Tokio Marine HCC for 2 years.
info2.pdf: Product manager at Veritas for 3 years.
"""
    answer = "David has 5 years of product management experience."
